...
void decode_opcode(CPU *cpu, uint16_t *stack, uint16_t opcode){
	switch((opcode >> 12)){
		...
		case 0x1: printf ("OP_JMP\n"); execute_opcode(cpu, stack, OP_JMP, opcode); break;
		case 0x2: printf("OP_EXC_SUB\n"); execute_opcode(cpu, stack, OP_EXC_SUB, opcode); break;
		case 0x3: printf("OP_SKIP_IF_ADR_EQL\n"); execute_opcode(cpu, stack, OP_SKIP_IF_ADR_EQL, opcode); break;
		case 0x4: printf("OP_SKIP_IF_ADR_NOT_EQL\n"); execute_opcode(cpu, stack, OP_SKIP_IF_ADR_NOT_EQL, opcode); break;
		case 0x5: printf("OP_SKIP_IF_REG_EQL\n"); execute_opcode(cpu, stack, OP_SKIP_IF_REG_EQL, opcode); break;
		case 0x6: printf("OP_STORE_VAL_ONE_REG\n"); execute_opcode(cpu, stack, OP_STORE_VAL_ONE_REG, opcode); break;
		case 0x7: printf("OP_ADD_VAL_ONE_REG\n"); execute_opcode(cpu, stack, OP_ADD_VAL_ONE_REG, opcode); break;
		case 0x8:
			switch(opcode & 0x000F){
				case 0x0: printf("OP_STORE_VAL_TWO_REG\n"); execute_opcode(cpu, stack, OP_STORE_VAL_TWO_REG, opcode); break;
				case 0x1: printf("OP_SET_BITWISE_OR\n"); execute_opcode(cpu, stack, OP_SET_BITWISE_OR, opcode); break;
				case 0x2: printf("OP_SET_BITWISE_AND\n"); execute_opcode(cpu, stack, OP_SET_BITWISE_AND, opcode); break;
				case 0x3: printf("OP_SET_BITWISE_XOR\n"); execute_opcode(cpu, stack, OP_SET_BITWISE_AND, opcode); break;
				case 0x4: printf("OP_ADD_VAL_TWO_REG\n"); execute_opcode(cpu, stack, OP_ADD_VAL_TWO_REG, opcode); break;
				case 0x5: printf("OP_SUBTRC_TWO_REG\n"); execute_opcode(cpu, stack, OP_SUBTRC_TWO_REG, opcode); break;
				case 0x6: printf("OP_STORE_RIGHT_SHIFTED_VAL_TWO_REG\n"); execute_opcode(cpu, stack, OP_STORE_RIGHT_SHIFTED_VAL_TWO_REG, opcode); break;
				case 0x7: printf("OP_SET_SUBTRC_TWO_REG\n"); execute_opcode(cpu, stack, OP_SET_SUBTRC_TWO_REG, opcode); break;
				case 0xE: printf("OP_STORE_LEFT_SHIFTED_VAL_TWO_REG\n"); execute_opcode(cpu, stack, OP_STORE_LEFT_SHIFTED_VAL_TWO_REG, opcode); break;
				default: printf("Unknown Opcode\n"); break;
			} break;
		case 0x9: printf("OP_SKIP_IF_REG_NOT_EQL\n"); execute_opcode(cpu, stack, OP_SKIP_IF_REG_NOT_EQL, opcode); break;
